...
Board.prototype.atIndex = function(index)
{
	return this.data[Math.floor(index / this.w)][index % this.w];
}

Board.prototype.setAtIndex = function(index, tid)
{
	this.data[Math.floor(index / this.w)][index % this.w] = tid;
}
